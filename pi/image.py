...
class Image:
    ...
    def Process(self):
        ...
        if self.contours:
            ...
            cv2.circle(self.image, (self.contourCenterX, self.middleY), 2, (255,255,255), -1) #Draw dX circle WHITE
            cv2.circle(self.image, (self.middleX, self.middleY), 2, (0,0,255), -1) #Draw middle circle RED
